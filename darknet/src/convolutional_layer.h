...
void forward_convolutional_layer_stipped(const convolutional_layer layer, network_state state, int nW);
void forward_convolutional_layer_mp(const convolutional_layer layer, network_state state, int nThreads);
void forward_convolutional_layer_stipped_mp(const convolutional_layer layer, network_state state, int nW, int nThreads);
